...
from ..utils import dist as udist
from ..augmentation.augmenter import get_dummy_augmenter
from ..data.datasets import CocoImageIDWrapper, ImageFolder, VideoDataset, SimpleVideoDataset
...
def setup_model_from_model_card(model_card: Union[Path, str]) -> Videoseal:
    """
